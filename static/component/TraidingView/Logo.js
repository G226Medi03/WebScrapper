...
class TraidingViewLogo extends HTMLElement {
    constructor() {
        super();
    }
    ...
    getBigHtml() {
        ...
        return `<div class="TraidingviewLogo" style="height: ${height}; width: ${width}; onclick=${onclick}"> 
                    <span>
                        <svg width="36" height="28" viewBox="0 0 36 28" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 22H7V11H0V4h14v18zM28 22h-8l7.5-18h8L28 22z" fill="${svgColor}"></path>
                        <circle cx="20" cy="8" r="4" fill="${svgColor}"></circle>
                        </svg>
                    </span>
                    <span>
                        <svg width="147" height="28" viewBox="0 0 147 28" xmlns="http://www.w3.org/2000/svg">
                        <path
    ...
    getHtml() {
        ...
        if (width >= "200px" || width == null || width == undefined) {
            return this.getBigHtml();
        }
        else {
